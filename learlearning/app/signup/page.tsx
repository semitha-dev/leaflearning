...
export default function SignupPage() {
  ...
  async function signUp(e: React.FormEvent) {
    ...
    // You can also auto-login after confirm; for now we let them confirm first.
  }
      ...
      <section className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="bg-white/90 rounded-2xl border border-amber-200 p-6">
          ...
          <p className="mt-4 text-sm text-stone-700">
            ...
            <Link href={`/login?redirect=${encodeURIComponent(redirectTo)}`} className="text-amber-700 hover:text-amber-800 inline-flex items-center gap-1">
